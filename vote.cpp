...
bool promptAndFillInVariables(vector<string>& votes, vector<int>& timeStamps, int& noOfVotes)
{
    string filename;
    string temp;
	string vote1;
...
int main(int argc, char **argv)
{
	...
	if (promptAndFillInVariables(votes, timeStamps, noOfVotes))
	{
		pMT theMerkleTree(1);
		...
		//cout << "The directions to 1211A3C787:Candidate2	6:	" << theMerkleTree.getMerkle()->locate("1211A3C787") << endl;
		cout << "Trying to find 4FCF8F701:Candidate2	6:	" << theMerkleTree.getMerkle()->find("15D2C1BA1EC") << endl;
	}
